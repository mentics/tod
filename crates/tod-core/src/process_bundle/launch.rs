...
/// Question context inlined into a deep-dive prompt.
///
/// Plain data describing *what* the agent is being asked about; the agent
/// transport layer never sees it, only the assembled prompt string.
#[derive(Debug, Clone)]
...
/// Prompt type lives in `tod-agent`; aliased here because this module
/// assembles them from bundled process docs.
pub use tod_agent::AgentPrompt as InterviewAgentPrompt;
